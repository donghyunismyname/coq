...
Proof.
  induction n.
  - reflexivity.
  - intro. simpl. rewrite IHn. reflexivity.
Qed.
...
Proof.
  intros P P0 P1 H.
  enough (pair:forall n, P n /\ P (S n)).
  - intro n.
    destruct (pair n).
    exact H0.
  - induction n.
    split. exact P0. exact P1.
    destruct IHn.
    split.
    + exact H1.
    + apply H. exact H0. exact H1.
Qed.
...
Proof.
  ...
  - rewrite IHn.
    simpl.
    destruct (evenb n). reflexivity. reflexivity.
Qed.
(** [] *)
