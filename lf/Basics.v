...
(* FILL IN HERE *)
Example aaa: bin_to_nat(incr (incr (incr (incr Z)))) = 4.
Proof. reflexivity. Qed.

Compute bin_to_nat(incr (incr (incr (incr (incr Z))))).
